...
//typedef enum {Primero, Segundo, Tercero} tAnio;
...
void ingresaRegistro(tLista& listita);
...
void buscaRegistrosEnLista(tLista& listita, string fragmento);


// Esta funcion busca 'fragmento' entre los Nombres y Apellidos de todas las listas del libro (base de datos)
void buscaRegistrosEnLibro(tLibro librito, string fragmento);
...
{
	cout << "---------------------------------------------------------------------" << endl ;
	cout << "| Apellidos: " << setw(55) << setiosflags(ios::right) << listita.elementos[posicion].apellidos << '|' << endl;
	cout << "| Nombres:   " << setw(55) << setiosflags(ios::right) << listita.elementos[posicion].nombres << '|' << endl;
	cout << "| Edad:      " << setw(55) << setiosflags(ios::right) << listita.elementos[posicion].edad << '|' << endl;
	cout << "| DNI:       " << setw(55) << setiosflags(ios::right) << listita.elementos[posicion].dni << '|' << endl;
	cout << "| Nota:      " << setw(55) << setiosflags(ios::right) << listita.elementos[posicion].nota << '|' << endl;
	cout << "| Registro:  " << setw(55) << setiosflags(ios::right) << posicion << '|' << endl;
...
void ingresaRegistro(tLista& listita)
{
	...
	getline(cin, listita.elementos[listita.contador].apellidos);

	cout << "Ingrese Nombres del alumno: ";
	getline(cin, listita.elementos[listita.contador].nombres);

	cout << "Ingrese la Edad del alumno: ";
	cin >> auxString;
	cin.ignore();
	listita.elementos[listita.contador].edad = atoi(auxString.c_str());

	cout << "Ingrese DNI del alumno: ";
	cin >> auxString;
	cin.ignore();
	listita.elementos[listita.contador].dni = atoi(auxString.c_str());

	cout << "Ingrese la NOTA del alumno: ";
	cin >> auxString;
	cin.ignore();
	listita.elementos[listita.contador].nota = atoi(auxString.c_str());
...
void buscaRegistrosEnLibro(tLibro librito, string fragmento)
{
	for (int i = 0; i < cantCarreras; ++i)
	{
		...
		{
			mostrarCabeceraCarrera(i,j);
			buscaRegistrosEnLista(librito[i][j], fragmento);
		}
	}
}
...
void ejecutarEnLista(int opcion, tLista& listita)
{
	...
	switch(opcion) {
	  ...
	  case 3:
	  	...
	  	cout << endl;
	  	buscaRegistrosEnLista(listita, fragmento);
	    break;
	  case 4:
	...
	do
	{
		switch(opcion)
		{
		  ...
		  case 'b':
		  	...
		  	getline(cin, fragmento);
		  	cout << endl;
		  	buscaRegistrosEnLibro(librito, fragmento);
		    break;
		  case 'c':
		  	system("cls");

...
// 0. Comprendo el Problema
// 1. Planteo un algoritmo (resualvo el problma algoritmicamente)
// 2. Escribo un codigo acorde al Algoritmo
...
void pedirDatos(){//Pedimos los datos al usuario
	...
	elemento = new int[nElementos]; //reservar un array de Enteros de N posiciones.
...
void mostrarArregloOrdenado(int *elemento,int nElementos){//Mostrando Arreglo ordenado
	...
	for(int i=0;i<nElementos;i++){
		cout<<*(elemento+i)<<" ";   //*elemento   *(elementoj+2)
	}
}

...
void escribeListaEnArchivoBin(string nombreArch, tLista& listita);
...
tLista leerListaDeArchivo(string nombreArch)
{
	...
	else
	{
		...
		{		
			...
			listita.elementos[listita.contador].nombres = linea ;

			getline(flujoIn,linea);
			listita.elementos[listita.contador].apellidos = linea ;
			
			getline(flujoIn,linea);
			auxInt = atoi(linea.c_str());
			listita.elementos[listita.contador].edad = auxInt ;

			getline(flujoIn,linea);
			auxInt = atoi(linea.c_str());
			listita.elementos[listita.contador].dni = auxInt ;

			getline(flujoIn,linea);
			auxInt = atoi(linea.c_str());
			listita.elementos[listita.contador].nota = auxInt ;
...
/*
double mediana(int notas[], int cant)
{

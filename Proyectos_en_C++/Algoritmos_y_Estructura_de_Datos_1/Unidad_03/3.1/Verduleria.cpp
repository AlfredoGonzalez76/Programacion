...
void menuPedido(bool pedir, tFruta fruta, int &banana, int &kiwi, int &mandarina, int &manzana, int &naranja, int &pera);
...
int main()
{
	...
	menuPedido(pedir, fruta, banana, kiwi, mandarina, manzana, naranja, pera);

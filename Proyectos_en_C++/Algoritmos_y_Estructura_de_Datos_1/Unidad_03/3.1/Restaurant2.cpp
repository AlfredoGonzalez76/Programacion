...
void codificaComanda(int &table, string &fh, int &waiter, int &pl1, int &pl2, int &pl3);



void decodificaMozo(int waiter);
...
void decodificaComanda(int table, string fh, int waiter, int pl1, int pl2, int pl3);
...
int codificaMozo(int mesa)
{
	return ((mesa-1)/6);// De este modo asigna equitativamente las mesas a los mozos
}
